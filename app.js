...
/*ejercicio 2 con document.write*/
...
/*ejercicio 2 con console.log*/
console.log('Ejercicio 2');
console.log('el primer numero es: ' + var1);
console.log('el segundo numero es: ' + var2);
console.log('la suma de los dos primeros numeros es: '  + (var1 + var2));
console.log('la resta de los dos primeros numeros es: '  + (var1 - var2));
console.log('el producto de los dos primeros numeros es: '  + (var1 * var2));
console.log('la division de los dos primeros numeros es: '  + (var1 / var2));
console.log('el primer numero (' + var1 + ') es ' + ((var1 % 2) == 0?'par':'impar'));
console.log('el segundo numero (' + var2 + ') es ' + ((var2 % 2) == 0?'par':'impar'));
console.log('el tercer numero es: ' + var3);
console.log('la suma de los tres numeros es: '  + (var1 + var2 + var3));
console.log('la resta de los tres numeros es: '  + (var1 - var2 - var3));
console.log('el producto de los tres numeros es: '  + (var1 * var2 * var3));
